...
import { type InstanceColumn } from "../../types/instanceColumns";

interface InstanceColumnManagerProps {
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-3 max-h-64">
              <DragDropContext onDragEnd={handleDragEnd}>
                <Droppable droppableId="instance-column-list">
                  {(provided) => (
...
export default memo(InstanceColumnManager);
